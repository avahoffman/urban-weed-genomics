...
setwd("/data/mavolio2/catalogs_by_species/CD_metapop_catalog/")

samps <- read.table("/scratch4/mavolio2/scratch_AH/popmap_CD_polyrad.txt", sep = "\t")
...
saveRDS(myStacks, "/scratch4/mavolio2/scratch_AH/CD_polyRADdata.rds")
