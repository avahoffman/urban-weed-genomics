...
table_ <- readr::read_csv("output/isolation-by-distance-mantel-test.csv")
knitr::kable(
  table_,
  format = "simple",
...
We also repeated this within city. Code for generating stats from the Mantel test and creating network plots can be found in the source code below.
...
table_ <- readr::read_csv("output/isolation-by-distance-by-city-mantel-test.csv")
knitr::kable(
  table_,
  format = "simple",
