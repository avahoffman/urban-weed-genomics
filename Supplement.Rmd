...
We used `hierfstat::basic.stats()` to calculate Fis. This is equal to (expected - observed) / expected, and thus gives a good estimate of whether there are more homozygotes than expected (positive number) or more heterozygotes than expected (negative number).
