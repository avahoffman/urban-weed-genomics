...
We performed hierarchical analysis of molecular variance (AMOVA; using GenoDive) based on the Rho-statistics, which is based on a Ploidy independent Infinite Allele Model.
