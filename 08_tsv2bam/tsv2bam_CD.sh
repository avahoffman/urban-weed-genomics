...
tsv2bam -P ~/scr4_mavolio2/scratch_JC/stacks/CD/CD_metapop_catalog \
 -M ~/scr4_mavolio2/scratch_JC/stacks/CD/CD_metapop_catalog/popmap_CD.txt \
 -R ~/scr4_mavolio2/scratch_JC/demux/CD -t 18
