...
-   [Introduction](#introduction)
    -   [Raw Data File Naming -
        Sublibraries](#raw-data-file-naming---sublibraries)
...
-   [Generating Stacks Catalogs and Calling SNPs
    ...
    -   [Step 5 - Metapopulation Catalog Building and Parameter
        ...
        -   [Step 5c - Correct File
            Names](#step-5c---correct-file-names)
        -   [Step 5d - Choose catalog
            samples/files](#step-5d---choose-catalog-samplesfiles)
    -   [Step 6 - Metapopulation catalog with
        `cstacks`](#step-6---metapopulation-catalog-with-cstacks)
    -   [Step 7 - Metapopulation locus matching with
        `sstacks`](#step-7---metapopulation-locus-matching-with-sstacks)
    -   [Step 8 - Metapopulation oriented by locus
        `tsv2bam`](#step-8---metapopulation-oriented-by-locus-tsv2bam)
    -   [Step 9 - Metapopulation SNP calling with
        `gstacks`](#step-9---metapopulation-snp-calling-with-gstacks)
    -   [Step 10 - Metapopulation summaries with
        `populations`](#step-10---metapopulation-summaries-with-populations)
    -   [Step 11 - Examine Within-city Catalogs and
        Populations](#step-11---examine-within-city-catalogs-and-populations)
    -   [Step 12 - City Level Population
        Analysis](#step-12---city-level-population-analysis)
-   [File Organization
    :bookmark_tabs:](#file-organization-bookmark_tabs)
...
## [01] Step 1 - Transfer Files {#step-1---transfer-files}

`01_transfer_files/01-aspera_transfer_n.txt`
...
software in general, should be compiled in an interactive mode. For more
...
`11-city_catalogs/12-city_populations.sh`. The goal of this script is to
