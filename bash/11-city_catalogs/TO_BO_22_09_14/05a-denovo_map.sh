...
#SBATCH --time=3:00:00
#SBATCH --job-name=dm_TO_BO
#SBATCH --mail-type=ALL
#SBATCH --mail-user=avamariehoffman@gmail.com
#SBATCH --error=denovo_map_TO_BO.%j.out
#SBATCH --output=denovo_map_TO_BO.%j.out
...
echo "Creating a by-city catalog for Taraxicum (TO) in Boston."

denovo_map.pl -M 6 -T 8 -o /home/ahoffm31/scratch4-mavolio2/scratch_AH/catalog_tests/TO_BO_22_09_14 \
  --popmap /home/ahoffm31/scratch4-mavolio2/scratch_AH/catalog_tests/TO_BO_22_09_14/popmap_TO_BO.txt \
