...
#SBATCH --time=6:00:00
#SBATCH --job-name=dm_PA_PX
#SBATCH --mail-type=ALL
#SBATCH --mail-user=avamariehoffman@gmail.com
#SBATCH --error=denovo_map_PA_PX.%j.out
#SBATCH --output=denovo_map_PA_PX.%j.out
...
echo "Creating a by-city catalog for Poa (PA) in Phoenix."

denovo_map.pl -M 5 -T 8 -o /home/ahoffm31/scratch4-mavolio2/scratch_AH/catalog_tests/PA_PX_22_09_14 \
  --popmap /home/ahoffm31/scratch4-mavolio2/scratch_AH/catalog_tests/PA_PX_22_09_14/popmap_PA_PX.txt \
