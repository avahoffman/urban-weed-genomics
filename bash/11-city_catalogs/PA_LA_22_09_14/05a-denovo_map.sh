...
#SBATCH --time=5:00:00
#SBATCH --job-name=dm_PA_LA
#SBATCH --mail-type=ALL
#SBATCH --mail-user=avamariehoffman@gmail.com
#SBATCH --error=denovo_map_PA_LA.%j.out
#SBATCH --output=denovo_map_PA_LA.%j.out
...
echo "Creating a by-city catalog for Poa (PA) in Los Angeles."

denovo_map.pl -M 5 -T 8 -o /home/ahoffm31/scratch4-mavolio2/scratch_AH/catalog_tests/PA_LA_22_09_14 \
  --popmap /home/ahoffm31/scratch4-mavolio2/scratch_AH/catalog_tests/PA_LA_22_09_14/popmap_PA_LA.txt \
