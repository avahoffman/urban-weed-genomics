...
#SBATCH --time=3:00:00
#SBATCH --job-name=dm_DS_BA
#SBATCH --mail-type=ALL
#SBATCH --mail-user=avamariehoffman@gmail.com
#SBATCH --error=denovo_map_DS_BA.%j.out
#SBATCH --output=denovo_map_DS_BA.%j.out
...
echo "Creating a by-city catalog for Digitaria (DS) in Baltimore."

denovo_map.pl -M 10 -T 8 -o /home/ahoffm31/scratch4-mavolio2/scratch_AH/catalog_tests/DS_BA_22_09_14 \
  --popmap /home/ahoffm31/scratch4-mavolio2/scratch_AH/catalog_tests/DS_BA_22_09_14/popmap_DS_BA.txt \
