...
#SBATCH --time=3:00:00
#SBATCH --job-name=dm_DS_PX
#SBATCH --mail-type=ALL
#SBATCH --mail-user=avamariehoffman@gmail.com
#SBATCH --error=denovo_map_DS_PX.%j.out
#SBATCH --output=denovo_map_DS_PX.%j.out
...
echo "Creating a by-city catalog for Digitaria (DS) in Phoenix."

denovo_map.pl -M 10 -T 8 -o /home/ahoffm31/scratch4-mavolio2/scratch_AH/catalog_tests/DS_PX_22_09_14 \
  --popmap /home/ahoffm31/scratch4-mavolio2/scratch_AH/catalog_tests/DS_PX_22_09_14/popmap_DS_PX.txt \
