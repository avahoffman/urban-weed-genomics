...
#SBATCH --error=denovo_map_PA_BA.%j.out
#SBATCH --output=denovo_map_PA_BA.%j.out
...
echo "Creating a by-city catalog for Poa (PA) in Baltimore."

denovo_map.pl -M 5 -T 8 -o /home/ahoffm31/scratch4-mavolio2/scratch_AH/catalog_tests/PA_BA_22_09_14 \
  --popmap /home/ahoffm31/scratch4-mavolio2/scratch_AH/catalog_tests/PA_BA_22_09_14/popmap_PA_BA.txt \
