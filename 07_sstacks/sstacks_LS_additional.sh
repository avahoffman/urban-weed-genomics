...
while read p; do
sstacks -c ~/scr4_mavolio2/scratch_JC/stacks/LS/catalog_7_13_22 \
  -s ~/scr4_mavolio2/scratch_JC/stacks/LS/catalog_7_13_22/"$p" \
  -o ~/scr4_mavolio2/scratch_JC/stacks/LS/catalog_7_13_22 \
  -p 10
done <~/scr4_mavolio2/scratch_JC/stacks/LS/catalog_7_13_22/sstacks_samples_LS_additional.txt
